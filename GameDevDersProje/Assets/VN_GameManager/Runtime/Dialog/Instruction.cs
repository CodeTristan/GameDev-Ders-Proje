...
{
    [XmlElement("DialogIndexBeforeChoices")] public int dialogIndexBeforeChoices;
    ...
    public ChoiceBody(ChoiceBody instruction) : this(0)
    {
        ...
        dialogIndexBeforeChoices = instruction.dialogIndexBeforeChoices;
    ...
    public ChoiceBody(XmlNode choiceBodyRootNode) : this(int.Parse(choiceBodyRootNode["ID"].InnerText))
    {
        ...
        dialogIndexBeforeChoices = int.Parse(choiceBodyRootNode["DialogIndexBeforeChoices"].InnerText);
...
public class ConditionalBranchInstruction : Instruction
{
    ...
    [XmlElement("ConditionText")] public string conditionText;
    ...
    public ConditionalBranchInstruction(ConditionalBranchInstruction ins) : this(0)
    {
        ...
        {
            conditions.Add(ConditionManager.instance.GetConditionByName(item.conditionName));
        }
        ...
        conditionText = ins.conditionText;
    ...
    public ConditionalBranchInstruction(XmlNode node) : this(int.Parse(node["ID"].InnerText))
    {
        ...
        conditionText = node["ConditionText"].InnerText;
    }
